...
userAuthRouter.post('/login',async(req,res)=>{
    ...
    try{
        ...
        const refreshToken = await refreshTokenSign(refreshTokenPayload,'user');
        const accessToken = await accessTokenSign(accessTokenPayload,'user');
...
userAuthRouter.get('/refresh',cookieParser,async(req,res)=>{
    ...
    try{
        ...
        const newAccessToken = await accessTokenSign(userRefreshToken,'user');
...
userAuthRouter.delete('/logout',cookieParser,async(req,res)=>{
    const userRefreshToken = req.cookies?.['refreshToken'];
